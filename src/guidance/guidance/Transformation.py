...
class Transformation(Node):
    def __init__(self):
        ...
        self.create_subscription(ControlTick, tick_topic, self.do_transformation, QOS_VEHICLE_DEFAULT)
    ...
    def do_transformation(self,msg):
        ...
        pixel_h = np.array([pixel_xy[0], pixel_xy[1], 1.0])
